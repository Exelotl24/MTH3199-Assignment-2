function class_2025_09_23()
    ...
    X_root = multivariat_Newton(@test_function01, Xguess, solver_params);
...
function X_root = multivariat_Newton(fun, X, solver_params)
